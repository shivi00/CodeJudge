...
class Problem(models.Model):
    ...
    input_format = models.TextField(default='', help_text='Text conatining Input format')
    output_format = models.TextField(default='', help_text='Text conatining Expected output format')
